...
It's written in java and the java bytecodes are compiled into [WebAssembly](https://webassembly.org) instructions using [TeaVM](https://teavm.org) and running on browser(AMAZING!).
