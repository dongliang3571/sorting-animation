...
function Hp(a,b,c,d,e){var f,g,h,i,j,k,l,m,n,o,p,$p,$z;$p=0;if(Gs()){var $T=B5();$p=$T.l();p=$T.l();o=$T.l();n=$T.l();m=$T.l();l=$T.l();k=$T.l();j=$T.l();i=$T.l();h=$T.l();g=$T.l();f=$T.l();e=$T.l();d=$T.l();c=$T.l();b=$T.l();a=$T.l();}_:while(true){switch($p){case 0:if(b!==null){f=b.data;g=f.length;if(g&&g!=1){if(d!=c){h=d-c|0;if(h!=1){if(e==(-1))return;i=$rt_createIntArray(10).data;j=Q(Be,h);h=Jp(10.0,e)|0;k=c;while(k<d){g=((f[k].c|0)/h|0)%10|0;i[g]=i[g]+1|0;k=k+1|0;}l=i.length;m=$rt_createIntArray(l).data;n
=0;k=m.length;while(n<k){m[n]=i[n];n=n+1|0;}o=1;while(o<l){i[o]=i[o-1|0]+i[o]|0;o=o+1|0;}j=j.data;o=d-1|0;while(o>=c){g=((f[o].c|0)/h|0)%10|0;j[i[g]-1|0]=BX(f[o].c);i[g]=i[g]-1|0;o=o+(-1)|0;}l=0;n=c;if(n<d){f[n].c=j[l].c;l=l+1|0;f[n].a=1;p=a.b;$p=1;continue _;}n=0;e=e-1|0;while(n<k){if(m[n]){d=c+m[n]|0;$p=2;continue _;}n=n+1|0;}return;}}return;}}return;case 1:F5(p,b);if(E()){break _;}f[n].a=0;n=n+1|0;if(n<d){f[n].c=j[l].c;l=l+1|0;f[n].a=1;p=a.b;continue _;}n=0;e=e-1|0;while(n<k){if(m[n]){d=c+m[n]|0;$p=2;continue _;}n
=n+1|0;}return;case 2:Hp(a,b,c,d,e);if(E()){break _;}c=c+m[n]|0;while(true){n=n+1|0;if(n>=k)break;if(m[n]){d=c+m[n]|0;continue _;}}return;default:FD();}}B5().s(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,$p);}
function Dm(){}
